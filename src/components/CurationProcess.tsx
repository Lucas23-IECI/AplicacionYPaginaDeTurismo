...
const steps = [
  {
    icon: Upload,
    step: '01',
    title: 'El organizador sube su actividad',
    description:
      'Los anunciantes envían la información de su evento: textos, imágenes, fechas, lugar y detalles a través de su portal exclusivo.',
  },
  {
    icon: PenLine,
    step: '02',
    title: 'Nuestro equipo revisa y mejora',
    description:
      'Cada publicación pasa por revisión editorial. Corregimos, optimizamos y aseguramos que el contenido cumpla el estándar de calidad.',
  },
  {
    icon: BadgeCheck,
    step: '03',
    title: 'Se publica con calidad premium',
    description:
      'Solo las actividades aprobadas aparecen en la plataforma. El resultado: una vitrina confiable, profesional y atractiva.',
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="relative text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary text-white mb-6 relative z-10">
                <step.icon size={28} />
              </div>
