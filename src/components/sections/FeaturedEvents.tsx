...
const events = [
  {
    id: 1, slug: 'vendimia-valle-itata', category: 'Tradición',
    title: 'Vendimia del Valle del Itata', city: 'Chillán Viejo',
    date: '26 Abr, 2026', distance: '12 km', price: '$15.000', tag: 'Curado',
    image: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=600&q=80&auto=format&fit=crop',
  },
  {
    id: 2, slug: 'feria-costumbrista-nuble', category: 'Cultura',
    title: 'Feria Costumbrista de Ñuble', city: 'Chillán',
    date: '19 Abr, 2026', distance: '3 km', price: 'Gratis', tag: 'Este finde',
    image: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=600&q=80&auto=format&fit=crop',
  },
  {
    id: 3, slug: 'senderismo-termas-chillan', category: 'Aventura',
    title: 'Senderismo Termas de Chillán', city: 'Nevados de Chillán',
    date: '20 Abr, 2026', distance: '82 km', price: '$25.000', tag: 'Cerca de ti',
    image: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&q=80&auto=format&fit=crop',
  },
  {
    id: 4, slug: 'festival-gastronomico-biobio', category: 'Gastronomía',
    title: 'Festival Gastronómico del Biobío', city: 'Concepción',
    date: '3 May, 2026', distance: '95 km', price: '$8.000', tag: 'Destacado',
    ...
    <section id="experiencias" className="py-24 px-6 max-w-7xl mx-auto scroll-mt-24">
      <AnimatedSection variant="fadeUp">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-12">
          ...
          <Link to="/eventos" className="text-sm font-semibold text-primary hover:text-primary-hover transition-colors whitespace-nowrap">
            Ver todas →
          </Link>
        </div>
      </AnimatedSection>
