    ...
    <section className="relative min-h-[92vh] flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-20">
        <div className="max-w-3xl mb-14">
          <span className="inline-block px-4 py-1.5 bg-accent/20 text-accent-light backdrop-blur-sm rounded-full text-xs font-semibold tracking-wider uppercase mb-8 border border-accent/30">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-xl leading-relaxed font-body">
        ...
        {/* Search module */}
        <div className="bg-white p-4 md:p-5 rounded-2xl shadow-2xl max-w-5xl">
