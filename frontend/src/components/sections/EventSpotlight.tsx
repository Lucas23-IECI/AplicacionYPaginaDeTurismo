      ...
      <div className="max-w-7xl mx-auto bg-stone-900 rounded-3xl overflow-hidden relative min-h-[500px] flex items-center">
        ...
        <div className="relative z-10 p-10 md:p-16 lg:p-20 max-w-2xl">
          <motion.span
            ...
            className="inline-block px-3 py-1 bg-accent text-white rounded-full text-xs font-bold uppercase tracking-wider mb-6"
          >
            Evento del mes
          </motion.span>
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-display text-white leading-tight mb-6"
          >
          ...
          >
            <Link to="/evento/vendimia-valle-itata" className="inline-flex items-center gap-2 bg-white text-stone-900 px-8 py-3.5 rounded-xl font-bold hover:bg-accent hover:text-white transition-all group">
